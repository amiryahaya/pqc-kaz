...
BEGIN {
    ...
    require '/Users/amirrudinyahaya/Workspace/PQC-KAZ/SIGN/combined/bindings/android/build/openssl/openssl-3.2.0/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/amirrudinyahaya/Workspace/PQC-KAZ/SIGN/combined/bindings/android/build/openssl/openssl-3.2.0/test/fips-and-base.cnf';
    shift;
