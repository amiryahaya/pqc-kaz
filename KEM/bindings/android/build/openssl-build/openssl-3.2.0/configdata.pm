...
our %config = (
    ...
    "openssl_sys_defines" => [],
    "openssldir" => "/Users/amirrudinyahaya/Workspace/PQC-KAZ/KEM/bindings/android/scripts/../build/openssl-build/build-x86/ssl",
    "options" => "-D__ANDROID_API__=24 --prefix=/Users/amirrudinyahaya/Workspace/PQC-KAZ/KEM/bindings/android/scripts/../build/openssl-build/build-x86/install --openssldir=/Users/amirrudinyahaya/Workspace/PQC-KAZ/KEM/bindings/android/scripts/../build/openssl-build/build-x86/ssl no-acvp-tests no-afalgeng no-asan no-brotli no-brotli-dynamic no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-md2 no-msan no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-tests no-tfo no-trace no-ubsan no-ui-console no-unit-test no-uplink no-weak-ssl-ciphers no-winstore no-zlib no-zlib-dynamic no-zstd no-zstd-dynamic",
    "patch" => "0",
    ...
    "perlargv" => [
        "android-x86",
        "-D__ANDROID_API__=24",
        "--prefix=/Users/amirrudinyahaya/Workspace/PQC-KAZ/KEM/bindings/android/scripts/../build/openssl-build/build-x86/install",
        "--openssldir=/Users/amirrudinyahaya/Workspace/PQC-KAZ/KEM/bindings/android/scripts/../build/openssl-build/build-x86/ssl",
        "no-shared",
        "no-tests",
        "no-ui-console"
...
unless (caller) {
    ...
    use lib '/Users/amirrudinyahaya/Workspace/PQC-KAZ/KEM/bindings/android/build/openssl-build/openssl-3.2.0/util/perl';
    use OpenSSL::fallback '/Users/amirrudinyahaya/Workspace/PQC-KAZ/KEM/bindings/android/build/openssl-build/openssl-3.2.0/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/Users/amirrudinyahaya/Workspace/PQC-KAZ/KEM/bindings/android/build/openssl-build/openssl-3.2.0/Configurations';
        use gentemplate;
