...
BEGIN {
    ...
    require '/Users/amirrudinyahaya/Workspace/PQC-KAZ/KEM/bindings/android/build/openssl-build/openssl-3.2.0/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/amirrudinyahaya/Workspace/PQC-KAZ/KEM/bindings/android/build/openssl-build/openssl-3.2.0/test/fips-and-base.cnf';
    shift;
